...
export class ReproductorComponentComponent implements OnInit {
  ...
  ngOnInit(): void {
    let Framer = {
      ...
      drawTick: function (x1, y1, x2, y2) {
        ...
        // colores de las ondas sonoras
        gradient.addColorStop(0, '#192382');
        gradient.addColorStop(0.6, '#253099');
        gradient.addColorStop(1, '#3341c4');
        this.context.beginPath();
      ...
      drawEdging: function () {
        ...
        this.context.strokeStyle = 'rgba(20, 31, 128, 0.5)';
        this.context.lineWidth = 1;
    ...
    var Tracker = {
      ...
      drawArc: function () {
        this.context.save();
        //color arco timer
        this.context.strokeStyle = 'rgba(20, 31, 128, 0.8)';
        this.context.beginPath();
    ...
    var Scene = {
      ...
      canvasConfigure: function () {
        ...
        this.context.strokeStyle = '#0c14f2';
        this.calculateSize();
      },
    ...
    var Controls = {
      ...
      initTimeHandler: function () {
        ...
        setTimeout(function () {
          ...
          var time = min.toString() + ':' + seconds.toString();
      ...
      drawPic: function () {
        ...
        this.context.lineWidth = 1;
        var x = Math.sqrt(Math.pow(Math.tan(Tracker.angle), 2) + 1);
        var y = Math.sqrt(x * x);
      ...
      tracks: [
        {
          ...
          url: "assets/audios/y2mate.com - Kurt  Vengo Del Futuro.mp3"
        }
      ],
